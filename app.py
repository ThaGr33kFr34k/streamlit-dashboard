    ...
    if drafts_df is not None and not drafts_df.empty:
        ...
        if selected_manager:
            ...
            if not manager_drafts.empty:
                ...
                # 4. Erstelle Draft-Übersicht für jede Saison (kompakter)
                ...
                with col4:
                    # Durchschnittliche Draft-Position
                    pick_col = None
                    ...
                    if pick_col and manager_drafts[pick_col].notna().any():
                        avg_pick = manager_drafts[pick_col].mean()
                        st.metric("Ø Draft-Pick", f"{avg_pick:.1f}")
                    else:
                        st.metric("Ø Draft-Pick", "N/A")
