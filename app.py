...
def main():
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <a href="https://dominationleague.streamlit.app/" target="_self" style="text-decoration: none; 
                   ...
                   ">
            <img src="{LOGO_URL}" style="height: 80px; margin-right: 20px;"> <h1 class="main-header" style="color: #c44b1f; font-size: 2.5rem; margin: 0; display: inline-block;">Domination League Analytics</h1> <img src="{LOGO_URL}" style="height: 80px; margin-left: 20px;"> </a>
    </div>
    """, unsafe_allow_html=True)
